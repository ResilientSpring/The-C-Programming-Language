...
//    a string constant generates a pointer that is holding itself's memory address.
//    a string constant generates a pointer that is holding its own memory address.
